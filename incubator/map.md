...
The agent re-reads the file at the start of every [Build](#build) and after any context compaction. Which rules it carries is settled by [Rule Selection](#rule-selection).
