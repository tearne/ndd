...
Decomposition item 4 (keystone sequence in `enhancement-discussion.md`). Depends on approval mechanics (built, archived 2026-09-10); relates to change 330 (tooling development) for the rendering surface. Renumbered from 90 on 2026-09-10 to sit with the sign-off theme at the end of the backlog.
